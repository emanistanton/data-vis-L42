<script>
  ...
  let pages = [
    { url: "/L6", title: "Home" },
    { url: "/L6/contact", title: "Contact" },
    { url: "/L6/projects", title: "Projects" },
    { url: "/L6/resume", title: "Resume" },
    { url: "/L6/meta", title: "Meta" },
    ...
    {#each pages as p}
      <li>
        <a
          ...
          class:current={p.url === "/L6"
            ? $page.url.pathname === base + "/L6" || $page.url.pathname === base + "/L6/"

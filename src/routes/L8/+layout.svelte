<script>
  ...
  let pages = [
    { url: "/L8", title: "Home" },
    { url: "/L8/contact", title: "Contact" },
    { url: "/L8/projects", title: "Projects" },
    { url: "/L8/resume", title: "Resume" },
    { url: "/L8/meta", title: "Meta" },
    ...
    {#each pages as p}
      <li>
        <a
          ...
          class:current={p.url === "/L8"
            ? $page.url.pathname === base + "/L8" || $page.url.pathname === base + "/L8/"
